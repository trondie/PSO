...
namespace PSO_Final
{
    ...
    class BPSO2
    {
        ...
        public BPSO2(int dim, double min_velocity, double max_velocity, int num_particles, double inertia, double min_inertia, bool inertia_decrease, double c1, double c2, bool k_volumes)
        {
        ...
        private double fitness_volumes(ref BParticle particle)
        {
            ...
            if (value > this.current_global_best)
        ...
        public void generate_random_bitvec(ref List<int> vec)
        {
            ...
            while (true)
            {
                ...
                if ((current_weight + 200) > WEIGHT_LIM)
                {
                    break;
                }
                vec[rand_value] = 1;
